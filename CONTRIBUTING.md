...
Thanks for contributing to nib!

This is a set of guidelines for contributing to nib. Please take a moment to review this document in order to make the contribution process easy and effective for everyone involved.

Following these guidelines helps to communicate that you respect the time of the developers managing and developing this open source project. In return, they should reciprocate that respect in addressing your issue, assessing changes, and helping you finalize your pull requests.

As for everything else in the project, the contributions to nib are governed by our [Code of Conduct][gh-coc]. By participating, you are expected to uphold this code. Please report unacceptable behavior at support@svengreb.de or directly to one of the core team members via [email][gh-mailmap].

## Getting Started

nib is an open source project and we love to receive contributions from the community! There are many ways to contribute, from [writing- and improving documentation and tutorials](#documentations), [reporting bugs](#bug-reports), [submitting enhancement suggestions](#enhancement-suggestions) which can be incorporated into this project by [submitting a pull request](#pull-requests).
...
- **Did the problem start happening recently** e.g. after updating to a new version of nib or was this always a problem?
  - If the problem started happening recently, **can you reproduce the problem in an older version of nib?**
...
- **Explain why this enhancement would be useful** to most nib users.
...
nib's documentation consists of guides, which helps users to learn about the project.
...
nib uses the [GitHub Flow][ghg-flow] branching model. The repository consists of the `main` core branch with an infinite development lifecycle. The source code of `HEAD` in this branch contains the latest development state and reflects all tagged release versions.
...
We're always looking for more opinions on discussions in issues and pull request reviews which is a good opportunity to influence the future direction of nib.
...
nib adheres to the [Arctic Ice Studio JavaScript Style Guide][gh-styleguide-javascript].

[![][gh-styleguide-javascript-badge]][gh-styleguide-javascript]

### Markdown Style Guide

nib adheres to the [Arctic Ice Studio Markdown Style Guide][gh-styleguide-markdown].
...
nib adheres to the [Arctic Ice Studio Git Style Guide][gh-styleguide-git].
...
[gh-branch-main]: https://github.com/svengreb/nib/tree/main
[gh-changelog]: https://github.com/svengreb/nib/blob/main/CHANGELOG.md
[gh-coc]: https://github.com/svengreb/nib/blob/main/CODE_OF_CONDUCT.md
[gh-gist]: https://gist.github.com
[gh-issues-label-question]: https://github.com/svengreb/nib/labels/type-question
[gh-issues-template-bug]: https://github.com/svengreb/nib/blob/main/.github/ISSUE_TEMPLATE/bugs.md
[gh-issues-template-enhancement]: https://github.com/svengreb/nib/blob/main/.github/ISSUE_TEMPLATE/enhancement.md
[gh-issues-template-pr]: https://github.com/svengreb/nib/blob/main/.github/PULL_REQUEST_TEMPLATE.md
[gh-issues-templates]: https://github.com/svengreb/nib/issues/new/choose
[gh-issues]: https://github.com/svengreb/nib/issues
[gh-mailmap]: https://github.com/svengreb/nib/blob/main/.mailmap
[gh-pr]: https://github.com/svengreb/nib/pulls
[gh-releases-latest]: https://github.com/svengreb/nib/releases/latest
